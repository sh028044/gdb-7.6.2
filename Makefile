...
target_alias=x86_64-apple-darwin13.0.0
target_vendor=apple
...
tooldir = ${exec_prefix}/x86_64-apple-darwin13.0.0
build_tooldir = ${exec_prefix}/x86_64-apple-darwin13.0.0
...
SUBDIRS =  intl libiberty opcodes bfd readline libdecnumber gdb etc
TARGET_CONFIGDIRS = 
# This is set by the configure script to the arguments to use when configuring
...
TARGET_SUBDIR = x86_64-apple-darwin13.0.0
# This is set by the configure script to the arguments to use when configuring
